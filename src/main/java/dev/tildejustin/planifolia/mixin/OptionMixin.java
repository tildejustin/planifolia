...
public abstract class OptionMixin {
    @WrapOperation(method = "method_18545", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/option/DoubleOption;getGenericLabel(Lnet/minecraft/text/Text;)Lnet/minecraft/text/Text;", ordinal = 1))
