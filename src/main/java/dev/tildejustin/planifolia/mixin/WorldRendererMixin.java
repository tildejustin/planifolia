...
public abstract class WorldRendererMixin {
    @WrapOperation(method = "getEntityStatistics", at = @At(value = "FIELD", target = "Lnet/minecraft/client/renderer/state/level/LevelRenderState;lastEntityRenderStateCount:I", opcode = Opcodes.GETFIELD))
